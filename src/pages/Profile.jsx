                    ...
                    <ul>
                    {
                        profileNavList.map((listItem)=>{
                            if(listItem.displayName === 'Logout') {
                                return (
                                    <li className='Logout-btn' key={listItem._id} onClick={logout}>
                                ...
                                return (
                                    <Link to={listItem.path} key={listItem._id} ><li className={location.pathname === listItem.path ? 'active' : null}>{listItem.displayName}</li></Link>
                                )
                            }
                        })
                    }
