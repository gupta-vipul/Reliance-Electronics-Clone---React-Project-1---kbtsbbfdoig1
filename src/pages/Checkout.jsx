    ...
    <div className='checkout-page'>
      <Accordion defaultExpanded={true}>
        ...
        <AccordionDetails>
          {
            !addressCardDetails ? 
            (<div className='no-address-checkout-page'>There are no save addresses.</div>) : 
            (<AddressCard cardDetails={addressCardDetails[0]}/>)
          }
          <div className='address-controls'>
            {
              addressCardDetails ? 
              (<Button variant="contained" sx={{fontSize: '0.8rem'}} onClick={handleAddressConfirmationBtn}>Deliver Here</Button>) :
              (null)
            }
        ...
        <AccordionDetails>
          <div className='final-cart-review'>
            ...
            <div className='final-cart-totalPrice'>
              ...
              <div className='final-cart-totalPrice-price'>₹{cartData?.data?.totalPrice}</div>
            </div>
          </div>
          <div className='cart-details-control'>
            {
              paymentGatewayTab ? 
              (<Button variant='contained' sx={{fontSize: '0.8rem'}} onClick={()=>setPaymentGatewayTab(false)}>proceed to payment</Button>) : 
              (null)
            }
          </div>
        </AccordionDetails>
