...
function AddressCard(props) {
  ...
  return (
    <div className="address-card-checkout">
      ...
      <div className="address-card-city">{`${cardDetails?.city}-${cardDetails?.zipCode}, ${cardDetails?.state}, ${cardDetails?.country}`}</div>
      <div className="address-card-mobile">
        <span>Mobile:</span> {`${cardDetails?.mobileno}`}
      </div>
    </div>
  );
}
